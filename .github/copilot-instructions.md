...
- `main.tex` is the sole document entrypoint. It loads the two-sided `elegantthesis` class and inputs every content module in a deliberate order: front matter, thesis overview and introduction, numbered chapters, inline parts, conclusion, appendix divider and appendices, then bibliography. Add a new structural module to this input sequence.
